...
const Puzzle = ({ setShowModal }) => {
    ...
    const handleTouchEnd = () => {
        ...
        else if (startPos.x - 100 > swipedTo.x) updateBlock(gameData, setGameData, setEndGame, setUserScore, setStart, "left");
            ...
            <div className="game_modal__wrapper">
                <div className="game_single__modal">
                    ...
                    <div className="App">
                        ...
                        <GameContainer setShowModal={setShowModal} gameData={gameData} start={start} score={userScore} endGame={endGame} handleReset={handleReset} />
                        <Guide />
                    </div>
                </div>
            </div>
