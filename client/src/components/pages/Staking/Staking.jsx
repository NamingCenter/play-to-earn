...
const Staking = () => {
  ...
  useEffect(async () => {
    await axios
      .post("http://3.39.230.11:5000/staking/amount", {
        address: account,
      })
      .then(async (res) => {
  ...
  useEffect(async () => {
    await axios
      .post("http://3.39.230.11:5000/staking/rewards", { address: account })
      .then((res) => {
                        ...
                        .then(async () => {
                          await StakingTokenContract.methods
                            ...
                            .then(async (res) => {
                              ...
                              await axios
                                .post("http://3.39.230.11:5000/staking", {
                                  stakerId: stakerId,
                                  address: address,
                                  amount: amount,
                                })
                          ...
                          await axios
                            ...
                            .then(async (res) => {
                              ...
                              dispatch(
                                updateMyBalance({
                                  Mybalance: (
                                    Number(Mybalance) + Number(unclaimreward)
                                  ).toString(),
                                })
                              );
                              //sleep(2000);
