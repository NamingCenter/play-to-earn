    ...
    const ITEMS = [
        {
            ...
            barValue: stakers === 0 ? 0 : ((parseInt(stakers) / parseInt(totalStakers)) * 100).toFixed(2),
            value: stakers,
            val: "명",
            png: UilClipboardAlt,
            series: [
        ...
        },
        {
            ...
            barValue: ((parseInt(stakingAmount) / (parseInt(checkMyBalance) + parseInt(stakingAmount))) * 100).toFixed(2),
            value: stakingAmount,
            val: "AAT",
        ...
        },
        {
            ...
            barValue: Number(totalreward) + Number(unclaimreward) === 0 ? 0 : ((Number(unclaimreward) / Number(totalreward)) * 100).toFixed(2),
            ...
            {ITEMS.map((card, id) => {
                return (
                    <div className="parent__container" key={id}>
                        <Card title={card.title} color={card.color} barValue={card.barValue} value={card.value} val={card.val} png={card.png} />
                    </div>
                );
            })}
        </div>
