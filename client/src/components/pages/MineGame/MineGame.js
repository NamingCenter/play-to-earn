...
function MineGame({ setShowModal }) {
    ...
    const sendPoint = async () => {
        ...
        const mineData = await axios
            .post(`http://15.165.17.43:5000/game/mine`, {
            ...
            <>
                <div className="game_modal__wrapper">
                    <div className="game_single__modal">
                        ...
                        <div className="box">
                            <main>
                                <InfoWrapper mines={gameAttr.mines} leftMines={gameAttr.mines - flagCount} gameState={gameState} handleRestart={handleRestart} runtime={runtime} handleShowSet={handleShowSet} />
                                <Board boardData={boardData} handleLeftClick={handleLeftClick} handleRightClick={handleRightClick} gameState={gameState} />
                            </main>
                        </div>
