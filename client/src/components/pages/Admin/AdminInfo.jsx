...
const AdminInfo = () => {
    ...
    useEffect(async () => {
        ...
        // setLoading(false);
    }, [TokenClaimContract, timer]);

    useEffect(async () => {
        if (AmusementArcadeTokenContract !== null) {
            const totalSupply = await AmusementArcadeTokenContract.methods.totalSupply().call();
    ...
    useEffect(async () => {
        await axios.post("http://15.165.17.43:5000/ranking/sendbalance").then(async (res) => {
