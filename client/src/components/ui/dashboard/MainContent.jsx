...
const MainContent = () => {
    ...
    return (
        <React.Fragment>
                                            ...
                                            return (
                                                <Fragment key={index}>
                                                    <Col key={index} className="my-items">
                                                        <MySellCard item={items} setCheckChange={setCheckChange} checkChange={checkChange} />
                                                    </Col>
                                                </Fragment>
                                            );
                                        })}
                                    ...
                                    <Slider {...settings} style={{ width: 900 }}>
                                        {selllists.map((items, index) => {
                                            return (
                                                <Fragment key={index}>
                                                    <Col key={index} className="my-items">
                                                        <MySellCard item={items} setCheckChange={setCheckChange} checkChange={checkChange} setLoading={setLoading} />
                                                    </Col>
                                                </Fragment>
                                            );
                                        })}
            ...
            {showModal && <SellModal item={MyModal} setShowModal={setShowModal} setCheckChange={setCheckChange} checkChange={checkChange} setLoading={setLoading} />}
        </React.Fragment>
    );
};
