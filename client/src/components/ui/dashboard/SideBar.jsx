...
const SideBar = () => {
    ...
    useEffect(() => {
        if (MyNFTlists.length !== 0) {
            ...
            if (MyNFTlists.filter((v) => v.formInput.rare === "5").length >= 3) {
                rareD = 3;
            } else if (MyNFTlists.filter((v) => v.formInput.rare === "4").length >= 3) {
                rareD = 2.5;
            } else if (MyNFTlists.filter((v) => v.formInput.rare === "3").length >= 3) {
                rareD = 2;
            } else if (MyNFTlists.filter((v) => v.formInput.rare === "2").length >= 3) {
                rareD = 1.5;
            } else {
                rareD = 1;
            }
            ...
            if (MyNFTlists.filter((v) => v.formInput.star === "5").length >= 3) {
                starD = 3;
            } else if (MyNFTlists.filter((v) => v.formInput.star === "4").length >= 3) {
                starD = 2.5;
            } else if (MyNFTlists.filter((v) => v.formInput.star === "3").length >= 3) {
                starD = 2;
            } else if (MyNFTlists.filter((v) => v.formInput.star === "2").length >= 3) {
                starD = 1.5;
            } else if (MyNFTlists.filter((v) => v.formInput.star === "1").length >= 3) {
                starD = 1.2;
            } else {
                starD = 1;
            }
    ...
    return (
        <div className="slide__container">
            {Loading ? (
                <div className={Loading ? "parentDisable" : ""} width="100%" height="100%" style={{ zIndex: "1" }}>
